...
// Drag-n-Drop SLIDER 
  ...
  (function() {
    ...
    // Menu elements 
    const menuElems = document.querySelectorAll('.header__item'),
    burgerElems = document.querySelectorAll(".header__nav-list");
